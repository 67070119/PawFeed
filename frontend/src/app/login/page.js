...
export default function LoginPage() {
  ...
  return <main className="authShell">
    <section className="authVisual"><div className="paw">🐾</div><div><h1>ช่วยกันดูแลสัตว์จรจัดในพื้นที่ของเรา</h1><p>ค้นหาจุดที่ต้องการความช่วยเหลือ ดูการให้อาหารล่าสุด และร่วมอัปเดตข้อมูลให้ชุมชน</p></div></section>
