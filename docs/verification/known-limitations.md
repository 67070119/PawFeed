...
- OpenStreetMap tiles และ OSRM-compatible routing provider เป็น external dependencies; Road Route Preview มีแล้ว แต่ Active turn-by-turn/off-route recalculation/voice guidance ยังเป็น Navigation Redesign Phase 3
