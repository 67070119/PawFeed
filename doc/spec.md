...
6. ผู้ใช้กด `นำทาง`
7. ระบบเปิดเส้นทางไปยังพิกัดของจุดผ่านบริการแผนที่ภายนอก เช่น Google Maps
...
### 5.7 Navigation
ระบบไม่สร้าง Navigation Engine เอง

เมื่อผู้ใช้กด `นำทาง` ระบบจะส่ง Latitude/Longitude ไปเปิดในบริการภายนอก เช่น Google Maps
...
- ไม่เก็บตำแหน่งปัจจุบันของผู้ใช้แบบต่อเนื่อง
...
- ระบบ Navigation แบบ Google Maps
